...
clear
echo "Step 1: "
echo "  Flash SD Card with Rock64 Image: out/base_images/rockpro64_base.img.gz"
echo "  OR"
echo "  If you would rather create your own base image, follow the"
echo "  manual instructions in setup/setup_base_image_rockpro64.txt"
echo ""
...
clear
echo "Step 2: "
echo "  Insert SD Card into your RockPro64 and boot the device"
echo ""
echo "Press a key when complete..."
read -n 1
