...
clear
echo "Step 1: "
echo "  Flash SD Card with Rock Pi 4 Image: out/base_images/rockpi4_base.img.gz"
echo "  OR"
echo "  If you would rather create your own base image, follow the"
echo "  manual instructions in doc/setup_base_image_rockpi4.md"
echo ""
...
clear
echo "Step 2: "
echo "  Insert SD Card into your Rock Pi 4 and boot the device"
echo ""
echo "Press a key when complete..."
read -n 1
