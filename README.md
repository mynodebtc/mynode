...
- RTL (Ride the Lightning) - Lightning Wallet (v0.10.0)
- Samourai Dojo (v1.8.0)
- Samourai Whirlpool (whirlpool-client-cli 0.10.9)
- Specter Desktop (v1.0.0)
- Thunderhub (v0.12.2)
- BTC RPC Explorer (v2.2.0)
- Mempool.Space - Mempool local visualizer for the Bitcoin blockchain (v1.0.1)
- LND Hub - Lightning Wallet Server (v1.2.0)
- Lndmanage (v0.11.0)
- Lightning Loop - A Non-Custodial Off/On Chain Bridge (v0.11.2-beta)
- Lightning Pool - A Non-Custodial auction for liquidity where bids are kept private and trades clear periodically (v0.4.1-alpha)
